...
#define I_EXP_SHARE_ITEM        GEN_5       // In Gen6+, the Exp. Share was changed from a held item to a Key item that toggles the effect described above. NOTE (difficulty hack): intentionally kept at GEN_5 so the Exp. Share stays a held item; do not raise to GEN_6+.
