...
#define P_PERFECT_PLAYER_IVS             TRUE        // Difficulty hack: all player-obtained Pokémon (wild, gifts, hatched eggs) have perfect IVs in all six stats. Trainer Pokémon are unaffected; their IVs come from trainer data.
