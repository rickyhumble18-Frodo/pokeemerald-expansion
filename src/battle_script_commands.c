...
static const s32 sExperienceScalingFactors[] =
{
    ...
    157872,
    159767,
    // Difficulty hack: extended from index 210 (level 100) to index 520 for MAX_LEVEL 255;
    // indices reach (faintedLevel * 2) + 10 and (faintedLevel + expGetterLevel + 10), both at most 520.
    161676,
    163598,
    165534,
    167484,
